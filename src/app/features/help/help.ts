...
const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Annual-fee reminders are scheduled 30 days before renewal, and card-expiry reminders are scheduled 45 days before the card expires at the end of its expiry month.',
