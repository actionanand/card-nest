...
const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Select For friends/relatives when the EMI belongs to someone else. Existing EMI plans without this field remain under Me.',
    ...
    tips: [
      'Loans & EMIs provides All, Me, and Friends & relatives tabs while retaining the recurring, converted EMI, and external loan sections.',
      'Closing an EMI plan stops all upcoming installments while retaining its history.',
    ],
  ...
  },
  {
    ...
    tips: [
      ...
      'If Android permission, the CardNest reminder channel, or schedule storage is unavailable, CardNest shows the exact scheduling problem instead of marking notifications ready.',
