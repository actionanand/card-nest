...
export class CardsPage {
  ...
  readonly form = new FormGroup({
    ...
    excludeStatementDayTransactions: new FormControl(true, { nonNullable: true }),
  ...
  edit(card: CreditCard): void {
    ...
    this.form.reset({
      ...
      excludeStatementDayTransactions: card.excludeStatementDayTransactions !== false,
  ...
  async save(): Promise<void> {
    ...
    const card: CreditCard = {
      ...
      excludeStatementDayTransactions: value.excludeStatementDayTransactions,
  ...
  private resetForm(): void {
    ...
    this.form.reset({
      ...
      cvv: '',
      statementDay: 15,
      excludeStatementDayTransactions: true,
